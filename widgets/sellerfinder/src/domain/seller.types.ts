...
export type SellerWithDistance = Seller & { distance: number | null };


export interface SellerFinderWidgetConfig {
...
export interface SellerFinderDataConfig {
...
export interface ResolvedSellerFinderConfig {
    readonly data: SellerFinderDataConfig;
    readonly integrations: ReactEdgeRuntimeIntegrations;
    readonly translations: TranslationsConfig
}
